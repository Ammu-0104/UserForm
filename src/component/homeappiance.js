  ...
  return (
    <div>
      <div className='row my-4'>
        <div className="labels col-12 col-md-2 px-3">Home Appliance Details</div>
       
      </div>

      <div className='row dmo_occupation pb-2'>
        <div className='col-12 col-md-2 pb-2'>
          <label htmlFor="applianceType" className='pb-2'>Select Appliance Type:</label>
          <select
        ...
        <div className='col-12 col-md-2 pb-2'>
          <label htmlFor="warrantyPeriod" className='pb-2'>Warranty Period:</label>
          <input
            className="form-control"
            type="date"
            id="warrantyPeriod"
        ...
        <div className="col-12">
          ...
          {applianceDetails.map((data, index) => (
            <div className="row" key={index}>
              <p className="col-12 col-md-2">Appliance Type: {data.applianceType}</p>

...
const VehicleSaleForm = () => {
  ...
  const handleAddDetails = () => {
    ...
    const existingDetailsIndex = vehicleDetails.findIndex((details) => details.vehicleType === selectedVehicle);
  ...
  const carBrands= {
    international: [
      'Audi', 'BMW', 'Mercedes-Benz', 'Volkswagen', 'Ford', 'Chevrolet',
      'Toyota', 'Honda', 'Nissan', 'Hyundai', 'Kia', 'Volvo', 'Mazda', 'Subaru',
      'Tesla', 'Ferrari', 'Lamborghini', 'Porsche', 'Maserati', 'Jaguar',
      'Land Rover', 'Jeep', 'Dodge', 'Chrysler', 'Buick', 'Cadillac', 'GMC',
      'Acura', 'Lexus', 'Infiniti', 'Mitsubishi', 'Lincoln', 'Alfa Romeo',
      'MINI', 'Fiat', 'Bentley', 'Rolls-Royce', 'McLaren'
    ],
    indian: [
      'Maruti Suzuki', 'Hyundai', 'Tata Motors', 'Kia', 'Mahindra & Mahindra',
      'Honda', 'Toyota', 'Volkswagen', 'Ford', 'Renault', 'Skoda', 'Nissan',
      'MG Motor', 'Audi', 'BMW', 'Mercedes-Benz', 'Ford', 'Jeep', 'Skoda',
      'Toyota', 'ISUZU', 'Jaguar', 'Volvo', 'Lexus', 'Land Rover', 'Porsche',
      'Ferrari', 'Rolls Royer', 'Bentley', 'Bugatti', 'Force Motors',
      'Mitsubishi', 'Bajaj Qute', 'Citroen', 'Lamborghini', 'MINI',
      'Aston Martin', 'Maserati', 'MC Laren', 'Pravaig models', 'Haval'
    ]
  };
  return (
    <div>
      ...
      <div className='row dmo_occupation'>
        <form className='row my-4'>
          <div className='col-12 col-md-2 pb-2'>
            ...
            <div>
              <select className='form-select' id="vehicleType" value={selectedVehicle} onChange={handleVehicleChange}>
          ...
          <div className='col-12 col-md-2 pb-2'>
            ...
            <select className='form-select' id="carBrands" value={selectedBrand} onChange={handleBrandChange}>
        ...
        <div className="col-12">
          ...
          {vehicleDetails.map((data, index) => (
            <div className="row" key={index}>
              <p className="col-12 col-md-2">Vehicle Type: {data.vehicleType}</p>
              <p className="col-12 col-md-2">Vehicle Number: {data.vehicleNumber}</p>
              ...
              <p className="col-12 col-md-2">Warranty Period: {data.warrantyPeriod}</p>
